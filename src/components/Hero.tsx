...
export const Hero: React.FC<HeroProps> = ({ onStartCheckin, onOpenJournalModal }) => {
  return (
    <section className="relative overflow-hidden pt-8 pb-16 lg:pt-14 lg:pb-24 rangkul-gradient">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-7 space-y-6 text-left">
            ...
            {/* Main Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#173D30] font-sans leading-[1.15] tracking-tight">
            ...
            {/* Subheadline */}
            <p className="text-base sm:text-lg text-[#35413A] leading-relaxed max-w-2xl font-normal">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-3 pt-2">
              ...
              <a
                href="#cara-kerja"
                className="px-6 py-4 bg-white hover:bg-[#F3F5F2] text-[#173D30] border border-[#DDE4DF] text-sm font-semibold rounded-2xl transition-all flex items-center justify-center gap-2"
              >
                <Play className="w-4 h-4 text-[#2E6F57] fill-current" />
            ...
            <div className="pt-4 border-t border-[#DDE4DF] flex flex-wrap items-center gap-4 text-xs text-[#35413A]">
              <div className="flex items-center gap-1.5 bg-white/80 backdrop-blur-sm px-3 py-1.5 rounded-lg border border-[#DDE4DF]">
